...
async function main() {
  try {
    // await contract.methods.addInterval("3600")
    ...
    await contract.methods.createPosition("test", ["0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174","0xBbba073C31bF03b8ACf7c28EF0738DeCF3695683",true], "1000", "3600", "3600")
    .send({ from: myAddress, gas: '500000' })
